...
need('3.13.0-home-test.5.1-safari-direct-10-where-am-i-5','version missing');
...
if(!sw.includes('property-inspector-home-test-313-direct-v10-where-am-i-5')) throw new Error('unique v5 cache missing');
console.log('PASS: WHERE AM I v5 has parcel boundary, live location, saved segmented trail, pan, pinch zoom, and unchanged evidence storage.');

...
need('3.13.0-home-test.5.1-safari-direct-10-where-am-i-4','version missing');
...
if(!sw.includes('property-inspector-home-test-313-direct-v10-where-am-i-4')) throw new Error('unique v4 cache missing');
console.log('PASS: WHERE AM I v4 has parcel boundary, live location, saved trail, pan, pinch zoom, and unchanged evidence storage.');

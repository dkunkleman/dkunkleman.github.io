...
assert(app.includes('const APP_VERSION = "3.15.0"') && app.includes('openFeatureCaptureSession("routeCondition")'));
assert(index.includes('id="featureCaptureDialog"') && index.includes("SAVE MINIMUM RECORD") && index.includes('id="soilProbe"'));
assert(worker.includes("field-truth-engine.js?v=3.15.0") && worker.includes("v21"));

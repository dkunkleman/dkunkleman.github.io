...
function main() {
  ...
  assert(workerSource.includes("inspection-coaching.js?v=3.10.0") && workerSource.includes("water-intelligence.js?v=3.10.0") && workerSource.includes("evidence-governance.js?v=3.10.0") && workerSource.includes("evidence-sets.js?v=3.10.0"), "coaching, water intelligence, governance, and Evidence Sets work offline from the service-worker cache");

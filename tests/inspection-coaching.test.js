...
function main() {
  ...
  assert(workerSource.includes("inspection-coaching.js?v=3.12.1") && workerSource.includes("water-intelligence.js?v=3.12.1") && workerSource.includes("evidence-governance.js?v=3.12.1") && workerSource.includes("evidence-sets.js?v=3.12.1") && workerSource.includes("timber-reconnaissance.js?v=3.12.1") && workerSource.includes("reviewed-property-synthesis.js?v=3.12.1"), "coaching, water intelligence, governance, Evidence Sets, timber reconnaissance, and reviewed synthesis work offline from the service-worker cache");

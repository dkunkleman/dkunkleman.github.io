...
function main() {
  ...
  assert(workerSource.includes("inspection-coaching.js?v=3.14.0") && workerSource.includes("water-intelligence.js?v=3.14.0") && workerSource.includes("evidence-governance.js?v=3.14.0") && workerSource.includes("evidence-sets.js?v=3.14.0") && workerSource.includes("timber-reconnaissance.js?v=3.14.0") && workerSource.includes("reviewed-property-synthesis.js?v=3.14.0") && workerSource.includes("authoritative-weather.js?v=3.14.0") && workerSource.includes("property-value-engine.js?v=3.14.0"), "coaching, water intelligence, governance, Evidence Sets, timber reconnaissance, reviewed synthesis, authoritative weather, and the value engine work offline from the service-worker cache");

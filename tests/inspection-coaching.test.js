...
function main() {
  ...
  assert(workerSource.includes("inspection-coaching.js?v=3.11.0") && workerSource.includes("water-intelligence.js?v=3.11.0") && workerSource.includes("evidence-governance.js?v=3.11.0") && workerSource.includes("evidence-sets.js?v=3.11.0") && workerSource.includes("timber-reconnaissance.js?v=3.11.0"), "coaching, water intelligence, governance, Evidence Sets, and timber reconnaissance work offline from the service-worker cache");

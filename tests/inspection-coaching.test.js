...
function main() {
  ...
  assert(workerSource.includes("field-truth-engine.js?v=3.16.2") && workerSource.includes("inspection-coaching.js?v=3.16.2") && workerSource.includes("water-intelligence.js?v=3.16.2") && workerSource.includes("evidence-governance.js?v=3.16.2") && workerSource.includes("evidence-sets.js?v=3.16.2") && workerSource.includes("timber-reconnaissance.js?v=3.16.2") && workerSource.includes("reviewed-property-synthesis.js?v=3.16.2") && workerSource.includes("authoritative-weather.js?v=3.16.2") && workerSource.includes("property-value-engine.js?v=3.16.2") && workerSource.includes("tree-identification-engine.js?v=3.16.2") && workerSource.includes("tree-network-engine.js?v=3.16.2"), "Field Truth, coaching, water intelligence, governance, Evidence Sets, timber reconnaissance, reviewed synthesis, authoritative weather, value, tree identification, and tree network work offline from the service-worker cache");

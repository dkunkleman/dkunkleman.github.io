...
(async () => {
  ...
  assert(worker.includes("authoritative-weather.js?v=3.16.3") && worker.includes("v25-simple-send"), "weather resolution and its verified fallback are cached for offline use");

...
(async () => {
  ...
  assert(worker.includes("authoritative-weather.js?v=3.16.1") && worker.includes("v23-recovery"), "weather resolution and its verified fallback are cached for offline use");

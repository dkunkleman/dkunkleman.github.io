...
assert(appSource.includes('const APP_VERSION = "3.16.1"'));
...
assert(workerSource.includes("property-inspector-field-2026-08-04-v23-recovery"));
assert(workerSource.includes("reviewed-property-synthesis.js?v=3.16.1"));

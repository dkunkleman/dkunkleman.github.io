...
assert(appSource.includes('const APP_VERSION = "3.13.0"'));
...
assert(workerSource.includes("property-inspector-field-2026-08-04-v19"));
assert(workerSource.includes("reviewed-property-synthesis.js?v=3.13.0"));

...
assert(workerSource.includes("timber-reconnaissance.js?v=3.16.3") && workerSource.includes("v25-simple-send"), "timber tools are cached for offline use in the new release");

...
assert(workerSource.includes("timber-reconnaissance.js?v=3.16.2") && workerSource.includes("v24-recovery"), "timber tools are cached for offline use in the new release");

...
assert(workerSource.includes("timber-reconnaissance.js?v=3.16.1") && workerSource.includes("v23-recovery"), "timber tools are cached for offline use in the new release");

...
Reviewed synthesis must make the property understandable without laundering interpretation into fact. Preserve every raw GPS point, break false route connectors, separate limited large-tract context from the primary small-tract inspection, and keep photo phases, vegetation zones, creek alignment, and homesite concepts pending until inspector approval. Buyer, seller, builder, forester, engineer, and internal reports may emphasize different decisions, but they must all use the same immutable evidence and limitations.

...
function importInspectionPackage(packagePath, repositoryRoot, options) {
  ...
  for (const [source, destination] of [
    ...
    ["PROPERTY_VALUE_ENGINE.json", `analysis/${contract.export_id}/PROPERTY_VALUE_ENGINE.json`],
    ["VALUE_DRIVER_HEAT_MAPS.json", `maps/${contract.export_id}/VALUE_DRIVER_HEAT_MAPS.json`],
    ["property-value-heat-map.html", `maps/${contract.export_id}/property-value-heat-map.html`],
    ["VALUE_DRIVER_REPORT_APPENDIX.md", `analysis/${contract.export_id}/VALUE_DRIVER_REPORT_APPENDIX.md`],
